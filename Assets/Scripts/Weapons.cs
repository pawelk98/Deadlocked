...
public class Weapons : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        weaponsData[0] = new float[] { 1.0f, 0.3f, 0.0f, 0.1f, 0f };   //melee
        weaponsData[1] = new float[] { 3.0f, 0.5f, 40.0f, 4.0f, 2.0f };  //pistol
        weaponsData[2] = new float[] { 1.5f, 0.1f, 35.0f, 4.0f, 5.0f };  //uzi    
        weaponsData[3] = new float[] { 4.0f, 0.2f, 50.0f, 4.0f, 1.0f };  //rifle    
        weaponsData[4] = new float[] { 5.0f, 0.8f, 30.0f, 4.0f, 5.0f };  //shotgun  
        //----------------------------------------------
    }
