...
public class Weapons : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        weaponsData[1] = new float[] { 2.0f, 0.5f, 30.0f, 5.0f, 2.0f };  //pistol
        weaponsData[2] = new float[] { 0.7f, 0.1f, 25.0f, 5.0f, 5.0f };  //uzi
        weaponsData[3] = new float[] { 5.0f, 1.0f, 20.0f, 5.0f, 5.0f };  //shotgun
        weaponsData[4] = new float[] { 3.0f, 0.2f, 40.0f, 5.0f, 1.0f };  //rifle
        //----------------------------------------------
    }
